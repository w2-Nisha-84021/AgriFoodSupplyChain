			...
			<div class="container"> 
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from createbatch");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	<%-- <td><img alt="Profile Pic" class="img-circle" src="Profilepic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td> --%>
                    	 ...
                    	 <td style="color:black"><%=rs.getString(11) %></td>
                    	  ...
                    	  <%--  <td><button class="contact-btn" style="background-color:green; width:70px;"><a style="color:white;" href="SendBatchCon?id=<%=rs.getInt(1)%>&status=<%=rs.getString(11)%>"><%=rs.getString(11)%></a></button></td> 
           --%>
            
           <th><button class="contact-btn" style="background-color:green; width:70px;"><a style="color:white;" href="SendBatchControl?id=<%=rs.getInt(1)%>&statuss=<%=rs.getString(12)%>"><%=rs.getString(12)%></a></button></th>
