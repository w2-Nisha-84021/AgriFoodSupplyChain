...
<section id="contact">
			<div class="container"> 
			 ...
			 <form action="ProcessorRawMaterialOrderCon" method="post">
               <%
                ...
                String pname=request.getParameter("pname");
                    ...
                    Statement st=con.createStatement();
                     ResultSet rs=st.executeQuery("select * from rowmaterial where pname='"+pname+"'"); 
                  /*  ResultSet rs=st.executeQuery("select * from addnewproduct"); */
                   /*  ResultSet rs=st.executeQuery("select addcategoryauction.id,addcategoryauction.categoryname,addsubcategoryauction.subcategoryname,addsessiondateauction.date,addsessiontimeauction.time,addcategoryauction.status from addcategoryauction inner join addsubcategoryauction on addcategoryauction.cat=addsubcategoryauction.cat inner join addsessiondateauction on addcategoryauction.cat=addsessiondateauction.cat inner join addsessiontimeauction on addcategoryauction.cat=addsessiontimeauction.cat");
                    ...
                    while(rs.next()) {
                   	%>
                   	<label><b>Raw Material Details</b></label>
                <div class="form-group mt-1">
                <input type="text" class="form-control" name="pname" id="pname" value="<%=rs.getString(4) %>" readonly>
              </div>
        ...
        <label><b>Add Payment To Farmer</b></label>
        
        <div class="form-group mt-1">
                <input type="text" class="form-control" name="name" id="name" value="<%=rs.getString(7) %>" readonly>
              </div>
     ...
     <div class="form-group mt-1">
              ...
              <label><b>Processor Name</b></label>
           <div class="form-group mt-1">
                <input type="text" class="form-control" name="uname" id="uname" value="${firstname } ${lastname }" readonly>
              </div>
               <div class="form-group mt-1" align="center">                        
                             
        <input type="Submit" class="about-btn" value="Submit"><br>
              ...
              <div class="col-lg-6">
              <img alt="Profile Pic" class="img-circle" src="rowmaterialpic.jsp?id=<%=rs.getInt(1) %>"  width="400px" height="400px"/></td>
