                ...
                try{
                     ...
                     //while(rs.next())
                   	...
                   	%>
                    	...
                    	<td><button style="background-color:green;"><a style="color:white;" href="BuyRawMaterialProcessor.jsp?pname=<%=rs.getString(4)%>">Buy Raw Material</a></button></td>
