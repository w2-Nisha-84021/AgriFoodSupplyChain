  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <!-- <img src="" class="material-icons opacity-10" alt=""> -->
       <center> <span class="ms-1 font-weight-bold text-white">Admin Login</span></center>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="AdminHome.jsp">
        ...
        <li class="nav-item">
          <a class= "nav-link text-white" href="Auction.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
       ...
       <!--  <li class="nav-item">
          <a class="nav-link text-white " href="AdminProfile.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-user-tie"></i>
            </div>
        ...
        <li class="nav-item">
          <a class= "nav-link text-white active bg-gradient-primary" href="ViewUsers.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-user-tie"></i>
            </div>
        ...
        <!-- <li class="nav-item">
          <a class="nav-link text-white " href="">
            ...
            <span class="nav-link-text ms-1">Mandi Rates</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="">
            ...
            <span class="nav-link-text ms-1">Loan Approval</span>
          </a>
        </li> -->
        <li class="nav-item">
          <a class="nav-link text-white " href="E-Market.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-shopping-cart"></i>
            </div>
            <span class="nav-link-text ms-1">E-Market</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="LogoutCon">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <!-- <li class="nav-item">
       ...
       <!-- <li class="nav-item mt-3">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="LoanApproval.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
          <a class="nav-link text-white " href="ViewProduct.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
           <!--    <i class="fa fa-shopping-cart"></i> -->
           
            <span class="nav-link-text ms-1">Delete Product</span> </div>
          </a>
        </li>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                Welcome<%response.setContentType("text/html");  
				 HttpSession sessio=request.getSession(true);  
	               if(session!=null){  
	               String email=(String)session.getAttribute("email");  
	                out.print(" "+email+""); }   %></b><i class="bi bi-chevron-down"></i>
              </a>
            </li>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <%
                  ...
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Scheme Name</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><%=rs.getString(2) %></h6>
                           
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><%=rs.getString(3) %></p>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><%=rs.getString(5) %> <%=rs.getString(6) %></span>
                      </td>
                      <td class="align-middle text-center">
                     ...
                     <!--  <td class="align-middle">
                      ...
                      <td><a class="badge badge-sm bg-gradient-success" href="UpdateGovtSchemeStatus?id=<%=rs.getInt(1)%>&status=<%=rs.getString(9)%>"><%=rs.getString(9)%></a></td>
                    	 <td><a class="badge badge-sm bg-gradient-success" href="DeleteGovtCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    </tr>
