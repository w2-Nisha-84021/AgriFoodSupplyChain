...
<body>
 ...
 <%--  <%
                    ...
                    /*  ResultSet rs=st.executeQuery("select * from user"); */ 
                     ...
                     /* ResultSet rs=st.executeQuery("SELECT DISTINCT (id) FROM [user] WHERE user.id In (select id from user where selectfield = 'Farmer'");  */
                     
                     ResultSet rs=st.executeQuery ("Select * from user where selectfield='Farmer'"); 
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
      ...
      <ul>
        <!-- <li><a href="Home.jsp"><img src="assets/img/IFlag.png">India</a></li> -->        
         <!--  <li><a href="UserProfileController">My Profile</a></li>    -->        
          ...
          <li><a style="color:white">Welcome<%response.setContentType("text/html");  
				 HttpSession sessio=request.getSession(true);  
	               if(session!=null){  
	               String firstname=(String)session.getAttribute("firstname");  
	                out.print(" "+firstname+""); }   %></a></li>
          </ul>
   ...
   <section id="services" class="services">
      <div class="container">
        ...
        <%--  <div class="section-title" data-aos="zoom-in">
         ...
         <h3>User <span>Profile</span></h3></div>
       <!--  
