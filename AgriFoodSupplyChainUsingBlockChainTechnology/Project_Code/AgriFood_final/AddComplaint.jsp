      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 video-box d-flex justify-content-center align-items-stretch" data-aos="zoom-in">
           <img src="assets/img/complaint.jpg">
          </div>
          ...
          <div class="col-xl-6 col-lg-6 d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <div class="icon-box" data-aos="fade-up" align="center">
              
             <h3>ADD <span>COMPLAINT</span></h3></div>
         
          <!-- <div class="col-lg-8"> -->
          <form action="AddComplaintCon" method="post">
              ...
              <div class="form-group mt-1">
                <input type="text" class="form-control" name="address" id="address" value="${citySelect }" required>
              </div>
              
              <div class="form-group mt-1">
                <input type="text" class="form-control" name="mobileno" id="mobileno" value="${mobileno }" required>
              </div>
               <div class="form-group mt-1">
                <input type="text" class="form-control" name="compagains" id="compagains" placeholder="complaint Agains" required>
              </div>
              <div class="form-group mt-1">
                <input type="text" class="form-control" name="reasonforcomp" id="reasonforcomp" placeholder="Reason for complaint" required>
              </div>
                  <div class="text-center">        
              <input type="Submit" class="comp-btn" value="Submit"><br>
                  </div>                 
              </form>
            </div>
