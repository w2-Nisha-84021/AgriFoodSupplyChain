...
<section id="contact">
			<div class="container"> 
				<div class="row">
                    ...
                    ResultSet rs=st.executeQuery("select * from neworder"); 
                     ...
                     if(rs.next() == false) {
		               ...
		               <!--  <th>Action</th>  --> 
                    	...
                    	<td style="color:black"><%=rs.getString(7) %></td>  
                    	  ...
                    	  <th><button style="background-color:green"><a style="color:white" href="ViewOrderSCon?id=<%=rs.getInt(1)%>&status=<%=rs.getString(9)%>"><%=rs.getString(9)%></a></button></th> 
