        ...
        <!-- <div class="row"> -->
          ...
          <div class="col-xl-6 col-lg-6 d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <h3>Register</h3>
              ...
              <form action="UserRegCon" method="post">
              
           
                <div class="form-group mt-1">
       
<select id="selectfield" name="selectfield" class="form-control custom-labels">
 		<option>Select Field</option>
 		<option value="Farmer" style="color: green;">Farmer</option>
 		<option value="Processor" style="color: blue;">Processor</option>
 		<option value="Distributor" style="color: red;">Distributor</option>
 		<option value="Retailer" style="color: purple;">Retailer</option>
 		<option value="Consumer" style="color: orange;">Consumer</option>
 	</select>
</div>
...
<select id="citySelect" class="form-control" name="citySelect" size="1" >
...
<!-- </body> -->
      ...
      <a href="UserLogin.jsp" style="color:red" >Already Register? Login here!!!</a>
