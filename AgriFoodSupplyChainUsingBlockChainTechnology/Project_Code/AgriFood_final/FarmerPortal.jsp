   ...
   <section id="services" class="services">
      <div class="container">
        <!-- <div class="row justify-content-between"> -->
         ...
         <div class="col-lg-6">
        <img alt="" src="assets/img/farmerportal.jpg" height="450px" width="500px">
        ...
        <div class="text-center">
          <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Add Raw Material For Sell</button>
          
          <button type="button" class="btn btn-info btn-lg"><a href="ViewRawMaterial.jsp" style="color:white;">View History</a></button>
        <button type="button" class="btn btn-info btn-lg"><a href="ViewRawMaterialRequestByProcessor.jsp" style="color:white;">View Raw Material Request</a></button>
...
<option value="Fruits">Fruits</option>
              ...
              <div class="form-group mt-1">
                <input type="text" class="form-control" name="" id="weight" placeholder="weight" required>
              </div>
                  <div class="text-center">        
              <input type="Submit" class="services-btn" value="Sell Product"><br>
                  </div>                 
              </form>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <form action="AddRowMaterial" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group mt-1">
                <input type="text" class="form-control" name="name" id="name" value="${firstname } ${lastname}" readonly>
              </div>
                  <div class="text-center">        
              <input type="Submit" class="services-btn" value="Sell Product"><br>
                  </div>                 
