  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <ul>
       ...
       <li><a href="SendApproval1.jsp">Product Verification</a></li>
       <li><a href="ViewGovtScheme2.jsp">Government Scheme Approval</a></li>
   ...
   <section id="services" class="services">
      <div class="container">
        <!-- <div class="row justify-content-between"> -->
            ...
            <center>     
         <div class="col-lg-12">
        <img alt="" src="assets/img/admin1.jpg" height="500px" width="500px">
