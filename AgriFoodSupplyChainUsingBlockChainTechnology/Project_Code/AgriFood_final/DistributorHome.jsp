   ...
   <section id="services" class="services">
      <div class="container">
        <!-- <div class="row justify-content-between"> -->
         ...
         <div class="col-lg-6">
        <img alt="" src="assets/img/dist.jpg" height="450px" width="500px">
        ...
        <div class="text-center">
          <button type="button" class="btn btn-info btn-lg" style="height:40px; width:200px;"><a href="ReceivedBatchDist.jsp" style="color:white;">Received Batch</a></button><br>
          
          
           <button type="button" class="btn btn-info btn-lg" style="height:40px; width:200px;"><a href="SendBatch.jsp" style="color:white;">Send Batch</a></button><br>
